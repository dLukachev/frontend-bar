        ...
        <div style={{ position: 'relative' }}>
          <button
            style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginLeft: 8, cursor: 'pointer',
              fontFamily: 'Tiffany, serif', fontSize: 31, color: '#410C00', fontWeight: 400,
              paddingLeft: 8, paddingRight: 8, position: 'relative'
            }}
            onClick={() => setShowCalendarModal(true)}
          >
            <span style={{ marginRight: 8 }}>{dayjs(selectedDate).format('DD.MM')}</span>
            <img src="/icons/strelka-booking.svg" alt="▼" style={{ width: 15, height: 9, display: 'inline-block' }} />
          </button>
          {showCalendarModal && (
            <CalendarModal
