    ...
    <div style={{ background: '#FFFBF7', minHeight: '91vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '34px' }}>
        <svg width="344" height="497" viewBox="0 0 344 497" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="61.4548" y="30.5254" width="38.4097" height="22.4838" rx="3" fill="#FFDEDA"/>
          <rect x="99.8646" y="15.5362" width="11.2419" height="38.4098" rx="3" transform="rotate(90 99.8646 15.5362)" fill="#FFDEDA"/>
          <rect x="101.318" y="56.7564" width="11.2419" height="16.8628" rx="3" transform="rotate(90 101.318 56.7564)" fill="#FFDEDA"/>
          <rect x="79.3176" y="56.7564" width="11.2419" height="16.8628" rx="3" transform="rotate(90 79.3176 56.7564)" fill="#FFDEDA"/>
          ...
          <rect x="122.348" y="30.5254" width="38.4097" height="22.4838" rx="3" fill="#F3ECE4"/>
          <rect x="160.758" y="15.5362" width="11.2419" height="38.4098" rx="3" transform="rotate(90 160.758 15.5362)" fill="#F3ECE4"/>
          <rect x="162.211" y="56.7564" width="11.2419" height="16.8628" rx="3" transform="rotate(90 162.211 56.7564)" fill="#F3ECE4"/>
          <rect x="140.211" y="56.7564" width="11.2419" height="16.8628" rx="3" transform="rotate(90 140.211 56.7564)" fill="#F3ECE4"/>
          ...
          <g style={{ cursor: 'pointer' }} onClick={() => handleTableClick(1)}>
            ...
            <rect x="106.455" y="334.993" width="11.2419" height="16.8628" rx="3" fill="#F3ECE4" />
          </g>

          {/* Стол №2 */}
          <g>
            <rect x="61.4548" y="219.764" width="38.4097" height="22.4838" rx="3" fill="#F3ECE4"/>
            <rect x="99.8646" y="204.774" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 204.774)" fill="#F3ECE4"/>
            <rect x="99.8646" y="245.995" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 245.995)" fill="#F3ECE4"/>
            ...
            <rect x="106.455" y="222.574" width="11.2419" height="16.8628" rx="3" fill="#F3ECE4"/>
          </g>

          {/* Стол №3 */}
          <g>
            <rect x="61.4548" y="275.973" width="38.4097" height="22.4838" rx="3" fill="#F3ECE4"/>
            <rect x="99.8646" y="260.984" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 260.984)" fill="#F3ECE4"/>
            <rect x="99.8646" y="302.204" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 302.204)" fill="#F3ECE4"/>
            ...
            <rect x="106.455" y="278.783" width="11.2419" height="16.8628" rx="3" fill="#F3ECE4"/>
          </g>

          {/* Левый нижний стол */}
          <g>
            <rect x="61.4548" y="107.345" width="38.4097" height="22.4838" rx="3" fill="#FFDEDA"/>
            <rect x="99.8646" y="92.3557" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 92.3557)" fill="#FFDEDA"/>
            <rect x="99.8646" y="133.576" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 133.576)" fill="#FFDEDA"/>
            ...
            <rect x="106.455" y="110.155" width="11.2419" height="16.8628" rx="3" fill="#FFDEDA"/>
          </g>
          {/* Центральный стол */}
          <g>
            <rect x="61.4548" y="163.554" width="38.4097" height="22.4838" rx="3" fill="#FFDEDA"/>
            <rect x="99.8646" y="148.565" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 148.565)" fill="#FFDEDA"/>
            <rect x="99.8646" y="189.785" width="11.2419" height="38.4097" rx="3" transform="rotate(90 99.8646 189.785)" fill="#FFDEDA"/>
            ...
            <rect x="106.455" y="166.365" width="11.2419" height="16.8628" rx="3" fill="#FFDEDA"/>
          </g>
          <rect x="249.756" y="438.98" width="38.4097" height="22.4838" rx="3" transform="rotate(-180 249.756 438.98)" fill="#FFDEDA"/>
          <rect x="211.347" y="453.969" width="11.2419" height="38.4098" rx="3" transform="rotate(-90 211.347 453.969)" fill="#FFDEDA"/>
          <rect x="209.894" y="412.749" width="11.2419" height="16.8628" rx="3" transform="rotate(-90 209.894 412.749)" fill="#FFDEDA"/>
          <rect x="231.894" y="412.749" width="11.2419" height="16.8628" rx="3" transform="rotate(-90 231.894 412.749)" fill="#FFDEDA"/>
          ...
          <rect x="265.682" y="338.74" width="38.4097" height="22.4838" rx="3" transform="rotate(90 265.682 338.74)" fill="#F3ECE4"/>
          <rect x="280.672" y="377.15" width="11.2419" height="38.4098" rx="3" transform="rotate(-180 280.672 377.15)" fill="#F3ECE4"/>
          <rect x="239.451" y="378.603" width="11.2419" height="16.8628" rx="3" transform="rotate(-180 239.451 378.603)" fill="#F3ECE4"/>
          <rect x="239.451" y="356.603" width="11.2419" height="16.8628" rx="3" transform="rotate(-180 239.451 356.603)" fill="#F3ECE4"/>
